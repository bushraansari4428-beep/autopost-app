      ...
      <div className="max-w-md w-full animate-in fade-in zoom-in-95 duration-500">
        <div className="bg-gray-900/60 backdrop-blur-2xl border border-gray-800 p-8 rounded-3xl shadow-2xl">
          <div className="text-center mb-8 flex flex-col items-center overflow-hidden">
            <img src="/logo.png" alt="AutoPost by NOOR Ali" className="w-72 sm:w-80 h-32 object-cover object-center transform scale-[1.6] sm:scale-[1.75] mb-2 drop-shadow-2xl hover:scale-[1.8] transition-transform" />
