...
async function testFetch() {
  ...
  if (stateMatch) {
    ...
    fs.writeFileSync('xhs_post_state.json', JSON.stringify(state, null, 2));
    console.log('Saved state to xhs_post_state.json');
    ...
    fs.writeFileSync('xhs_post_error.html', html);
  }
}
testFetch();
